...
-- ----------------------------
BEGIN;
INSERT INTO `pay_app` (`id`, `app_key`, `name`, `status`, `remark`, `order_notify_url`, `refund_notify_url`,
                       `transfer_notify_url`, `creator`, `create_time`, `updater`, `update_time`, `deleted`,
                       `tenant_id`)
VALUES (1, 'mall', '商城应用', 0, NULL, 'http://127.0.0.1:48080/app-api/trade/order/update-paid',
        'http://127.0.0.1:48080/admin-api/trade/after-sale/update-refunded', '', '1', '2023-02-11 21:20:54', '1',
        '2024-08-18 07:32:54', b'0', 1),
       (7, 'demo', '示例应用', 0, NULL, 'http://127.0.0.1:48080/admin-api/pay/demo-order/update-paid',
        'http://127.0.0.1:48080/admin-api/pay/demo-order/update-refunded', '', '1', '2023-02-11 21:20:54', '1',
        '2024-08-18 07:32:57', b'0', 1),
       (8, 'wallet', '会员钱包', 0, NULL, 'http://127.0.0.1:48080/admin-api/pay/wallet-recharge/update-paid',
        'http://127.0.0.1:48080/admin-api/pay/wallet-recharge/update-refunded', '', '1', '2023-09-30 18:43:09', '1',
        '2024-08-18 15:50:49', b'0', 1);
COMMIT;
...
(
  ...
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT = '示例业务转账订单';
...
(
  ...
  AUTO_INCREMENT = 31
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT = '会员钱包充值';
...
(
  ...
  AUTO_INCREMENT = 3
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT = '充值套餐表';
